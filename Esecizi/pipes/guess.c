...
int main(void) {
    ...
    for (int i=1; i<=ROUND; i++) {
        ...
        printf("[PARENT] Press ENTER to generate random number\n");
        ...
        if (dist1 > dist2) {
            printf("[PARENT] Child 1 WIN the round\n");
            score1++;
        }
        else if (dist1 < dist2) {
            ...
            printf("[PARENT] Both child WON the round\n");
            score2++;
            score1++;
        }
    }
